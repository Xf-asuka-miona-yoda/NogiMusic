...
public class Classinfo extends Fragment {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 1:
                    classname.setText(classinfoname);
                    musicList.clear();
                    sendrequest_class_info();
                    break;
                default:
                    break;
            }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.classinfo_layout, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        classname = (TextView) view.findViewById(R.id.classinfo_name);
        ImageButton back = (ImageButton) view.findViewById(R.id.backto_class);
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Global_Variable.fragmentTransaction.show(homeActivity.music_home_fragment.classification);
    ...
    public void initmusicadapter(){
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.class_music);
    ...
    public void sendrequest_class_info(){
            ...
            public void run() {
                try {
                    ...
                    RequestBody requestBody = new FormBody.Builder()
                            .add("musictype", classinfoname) //请求参数
                            .build();
                    Request request = new Request.Builder()
                            .url(Global_Variable.ip + "NogiMusic/musictype") //请求url
                            .post(requestBody)
                            .build();
                    Response response = client.newCall(request).execute();
                    String data = response.body().string();
                    Log.d("NMSL", data);
                    parsejsonclass(data); //解析服务端返回的值
                } catch (Exception e){
                    e.printStackTrace();
                }
            }
    ...
    private void parsejsonclass(String data) {
        Gson gson = new Gson();
